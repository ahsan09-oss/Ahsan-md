...
<img src="utils/bot_image.jpg" alt="Ali-MD" width="260">

</div>

Ali-MD is a WhatsApp MD bot built on top of the Baileys library.
...
· Session ID (recommended for panels):
    Use the Pair Code Generator to scan a QR and obtain a session string starting with Ali-MD!....
...
· Option A: Use session string
    Paste your session ID (starting with Ali-MD!...) into sessionID.
...
```bash
npm i -g pm2
pm2 start index.js --name Ali-MD --time
pm2 save
pm2 startup
```
...
To create new commands (plugins) for Ali-MD, copy the entire prompt below and send it to an AI (like ChatGPT) – it will generate production‑ready plugins aligned with the repository's architecture.
<detail>
...
module.exports = {
  ...
  newsletterJid: '120363403978278535@newsletter',
  updateZipUrl: 'https://github.com/proboy315/Ali-MD/archive/refs/heads/main.zip',
  packname: 'Ali-MD',
  selfMode: false,
  autoRead: false,
  autoTyping: true,
...
· Pairing/session:
  · Bot supports Session ID format Ali-MD!<base64gzip>
